...
def validate_credentials():
   return OAUTH_CONSUMER_KEY != UNCONFIGURED_CREDENTIAL_VALUE and OAUTH_CONSUMER_SECRET != UNCONFIGURED_CREDENTIAL_VALUE and OAUTH_ACCESS_TOKEN != UNCONFIGURED_CREDENTIAL_VALUE and OAUTH_ACCESS_SECRET != UNCONFIGURED_CREDENTIAL_VALUE
